  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'thesleeksolutionsltd@gmail.com',
      href: 'mailto:thesleeksolutionsltd@gmail.com',
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+254 706 824 750',
      href: 'tel:+254706824750',
    },
    {
      icon: MapPin,
      label: 'Location',
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-card-hover p-8">
              ...
              <div className="w-full h-48 bg-gradient-to-br from-brand-green/20 to-neon-cyan/20 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-foreground/70 font-body">Our Location</p>
                  <p className="text-sm text-foreground/50 font-body">Nairobi, KE</p>
                </div>
              </div>
            </Card>
