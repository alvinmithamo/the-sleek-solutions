...
const PortfolioSection = () => {
  ...
  const projects = [
    ...
    // },
    {
      ...
      category: 'Website',
      description: 'A portfolio website for a venture company focused on sustainable development.',
      detailedDescription: 'Developed a modern, responsive website that highlights Kobo East Africa\'s mission and services.',
      image: '/api/placeholder/600/400',
      technologies: ['WordPress', 'Elementor'],
      results: ['Increased online visibility', 'Improved user engagement'],
      liveUrl: 'https://kobo-eastafrica.com/',
      githubUrl: '#',
      featured: true,
    },
    {
      ...
      title: 'Kobo Sport',
      category: 'Website',
      description: 'A modern sports and fitness website for Kobo Sport. Features modern design and responsive layout.',
      detailedDescription: 'Developed a responsive website for Kobo Sport that showcases their sports and fitness services with an emphasis on modern design and user experience. The site features a clean, modern interface with optimized performance and seamless user navigation.',
      image: '/api/placeholder/600/400',
      technologies: ['WordPress', 'Elementor'],
      results: ['Enhanced online presence', 'Improved user engagement'],
      liveUrl: 'https://kobosport.com/',
      githubUrl: '#',
      featured: false,
    },
    {
      id: 3,
      title: 'Sidonie Latere',
      category: 'Website',
      description: 'A portfolio website for an entrepreneur and business consultant.',
      detailedDescription: 'Developed a comprehensive portfolio website for Sidonie Latere that showcases her entrepreneurial journey and business consulting services. The site features a modern, professional design with optimized performance and seamless user experience.',
      image: '/api/placeholder/600/400',
      technologies: ['WordPress', 'Elementor'],
      results: ['Professional online presence', ],
      liveUrl: 'https://sidonielatere.com/',
      githubUrl: '#',
      featured: false,
    },
    {
